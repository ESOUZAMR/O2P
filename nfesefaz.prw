...
±±³01/04/2009³Luiz Cesar     ³Implantacao da NFE                          ³±±
±±³07/04/2009³Luiz Cesar     ³Correcao mensagem fiscais customizadas      ³±±
±±³          ³               ³omissao data entrada/saida                  ³±±
±±³13/04/2009³Luiz Cesar     ³Gravacao dos dados do Veiculo               ³±±
±±³16/04/2009³Luiz Cesar     ³Ajustes notas geradas pelo EIC              ³±±
±±³28/04/2009³Luiz Cesar     ³Ajustes busca descric prod EIC              ³±±
±±³13/05/2009³Luiz Cesar     ³Tratamento para devolucoes (Entrada)        ³±±
±±³28/05/2009³Luiz Cesar     ³Tratamento para Compl ICMS (CIAP)           ³±±
±±³24/06/2009³Luiz Cesar     ³Numero DCRE - Manaus                        ³±±
±±³14/10/2009³Luis Alberto   ³Inclusao de mensagem para nota fiscal de    ³±±
±±³          ³               ³venda de cliente on site  com pallets       ³±±
±±³          ³               ³originarios de armazem externo.             ³±±
±±³28/12/2009³Luiz Cesar     ³Geracao de codigo randomico chave nfe       ³±±
±±³29/04/2010³Allan Bonfim   ³Não enviar e-mail XML para fornecedores     ³±±
±±³          ³               ³estrangeiros - Estado EX - Chamado 195664   ³±±
±±³31/05/2010³Luiz Cesar     ³Informacao de container para importacoes    ³±±
±±³16/08/2010³Katia Cruz(JMJ)³Versao 2.0 NF-e.                            ³±±
±±³23/09/2010³Allan Bonfim   ³Correção valores Despesas e Total da NF-e de³±±
±±³          ³               ³Importação e Alias SD2 - Chamado 195664 	  ³±±
±±³24/09/2010³Allan Bonfim   ³Correção error.log "array out of bounds [2] ³±±
±±³          ³               ³of [1]  on U_XMLNFESEF(NFESEFAZ.PRW)	 	  ³±±
±±³27/09/2010³Allan Bonfim	 ³Equalização NFESEFAZ padrão X Custom. Crown ³±±
±±³28/09/2010³Allan Bonfim	 ³Impressão de várias Naturezas Oper. (CFOP)  ³±±
±±³          ³               ³para as notas de entreda				 	  ³±±
±±³30/09/2010³Allan Bonfim	 ³Correção erro na transmissão NF Devolução   ³±±
±±³22/10/2010³Luiz Cesar     ³Gravar etiquetas no XML tag infadprod - PIA ³±±
±±³          ³               ³Implantado Por Ricardo Lima                 ³±±
±±³11/11/2010³Ricardo Lima   ³Correcao para notas que usam fornecedor     ³±±
±±³12/11/2010³Ricardo Lima   ³Correcao para notas de entrada/importacao   ³±±
±±³16/11/2010³Ricardo Lima   ³Correcao Operador Logistico                 ³±±
±±³18/11/2010³Ricardo Lima   ³Correcao na entrada do Array                ³±±
±±³22/11/2010³Allan Bonfim   ³Correção erro na transmissão NF Complementar³±±
±±³			 ³			     ³- Chamado 208358							  ³±±
±±³22/11/2010³Ricardo Lima   ³Ajuste para evitar problemas, nfe entrada.  ³±±
±±³24/11/2010³Ricardo Lima   ³Ajuste na formatacao das etiquetas PIA.     ³±±
±±³29/12/2010³Alberto        ³Correção na mensagem do PIS/COFINS de pauta ³±±
±±³			 ³			     ³que nao estava sendo gravado na mensagem    ³±±
±±³			 ³			     ³complementar da nf-e. Chamado 208.818       ³±±
±±³10/01/2011³Alberto        ³Inclusao da mensagem ref. ao diferimento do ³±±
±±³			 ³			     ³ICMS para Ponta Grossa.Chamado 208.430      ³±±
±±³25/03/11  ³J.Francisco    ³Correcao do tamanho do e-mail do cliente+   ³±±
±±³			 ³			     ³transportadora = 60 caracteres              ³±±
±±³28/03/11  ³J.Francisco    ³Chamado 215960 Tratamento local de embarque ³±±
±±³			 ³			     ³p/exportacao obrigatorio P/Versao 2.00      ³±±
±±³29/03/2011³Alberto        ³Correcao projeto PIA. Alterarao para gravar ³±±
±±³			 ³			     ³corretamente a etiqueta no xml enviado ao   ³±±
±±³			 ³			     ³operador logistico.                         ³±±
±±³29/03/2011³Alberto        ³Correcao projeto PIA. Inclusao para trata-  ³±±
±±³			 ³			     ³mento da etiqueta (PB5_ORIGEM ='P'),identi- ³±±
±±³			 ³			     ³ficando que eh uma etiqueta de origem do PIA³±±
±±³29/03/2011³Alberto        ³Informar a qtde da etiqueta no xml enviado  ³±±
±±³			 ³			     ³ao operador logistico.                      ³±±
±±³12/07/2011³Alberto        ³A partir de 01/05/11 para as notas fiscais  ³±±
±±³			 ³			     ³eletronicas transmitidas em ambiente de     ³±±
±±³			 ³			     ³homologacao as seguintes tags do destinatario±±
±±³			 ³			     ³devem ser preenchidas com o seguinte conteudo±±
±±³			 ³			     ³Operacao interna:                           ³±±
±±³			 ³			     ³<CNPJ>99999999000191/<CNPJ>                 ³±±
±±³			 ³			     ³<xNome>NF-E EMITIDA EM AMBIENTE DE HOMOLOGACAO±±
±±³			 ³			     ³- SEM VALOR FISCAL</xNome>                  ³±±
±±³			 ³			     ³<IE></IE>                                   ³±±
±±³			 ³			     ³Operacao externa:                           ³±±
±±³			 ³			     ³<CNPJ>/<CNPJ>                               ³±±
±±³			 ³			     ³<xNome>NF-E EMITIDA EM AMBIENTE DE HOMOLOGACAO±±
±±³			 ³			     ³- SEM VALOR FISCAL</xNome>                  ³±±
±±³			 ³			     ³<IE></IE>                                   ³±±
±±³12/07/2011³Alberto        ³Gravar codigo do material de embalagem por  ³±±
±±³			 ³			     ³etiqueta no xml de envio para o operador    ³±±
±±³			 ³			     ³logistico(KMC). Projeto de melhoria do PIA.  ±±
±±³13/07/2011³Alberto        ³Gravar a qtde do material de embalagem por  ³±±
±±³			 ³			     ³etiqueta no xml de envio para o operador    ³±±
±±³			 ³			     ³logistico(KMC). Projeto de melhoria do PIA.  ±±
±±³14/07/2011³Alberto        ³Gravar a informacao da etiqueta na tag      ³±±
±±³			 ³			     ³infcpl. Projeto de melhoria do PIA          ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³31/08/2011³Felipe         ³Busca o tipo do frete (CIF ou FOB) apenas no³±±
±±³          ³               ³pedido de produto acabado ou intermediario  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³31/10/2011³Felipe/Alberto ³Ajuste ref. NT2011/004. Nao gravar o campo  ³±±
±±³          ³CH 231403      ³B1_CODBAR no array aprod. Essa alteracao foi³±±
±±³          ³               ³efetuada para evitar rejeicao na tag cEan   ³±±
±±³          ³               ³na transmissao da nf-e. NF Saida            ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³08/11/2011³Fernando Avelar³Ajuste ref. NT2011/004. Nao gravar o campo  ³±±
±±³          ³CH 231403      ³B1_CODBAR no array aprod. Essa alteracao foi³±±
±±³          ³               ³efetuada para evitar rejeicao na tag cEan   ³±±
±±³          ³               ³na transmissao da nf-e. NF Entrada          ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³07/02/2012³Cristiane      ³Ajuste ref. NT2011/004. Rejeicao 629 e 630  ³±±
±±³          ³CH 237395      ³Aumentei as casas decimais para nova valida-³±±
±±³          ³               ³cao de valor unitario.                      ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³21/03/2012³Felipe (MRC)   ³Projeto A004/12: Numero do Pedido do Cliente³±±
±±³          ³CH 240635      ³na tabela de precos, XML e DANFE			  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³24/04/2012³Felipe (MRC)   ³Projeto A012/12: Configuracao de DANFE para ³±±
±±³		 	 ³CH 241662      ³EXPORTACAO - Imprimir o numero do container ³±±
±±³		 	 ³               ³em informacoes adicionais                   ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³26/07/2013³Cristiane      ³Restaurar a area das tabelas SF1 e SD1.     ³±±
±±³          ³CH 275656      ³                                            ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³24/09/2013³Alberto        |Projeto FCI. Criada mensagem para a Ficha de³±±
±±³          ³CH 269197      ³conteudo de importacao.                     ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³01/10/2013³Alberto        |Projeto FCI. Retirada condicao de validacao ³±±
±±³          ³CH 269197      ³do CST para geracao da mensagem da FCI      ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³28/10/2014³Adriano Guedes |Retirado FCI dos Itens, sendo informado agora±±
±±³          ³CH 288862      ³nas mensagens                               ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³10/02/2014³Adriano Guedes |Alterado qCom para 5 casas decimais tam 16   ±±
±±³          ³CH 289453      ³para atender padrao do EIC                  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³07/03/2014³Alex Borges    |Acrescentar o número da OP em informações   ³±±
±±³          ³CH 290430      ³adicionais                                  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³13/03/2014³Adriano Guedes | Criado TAg nFci, conforme nova resolucao    ±±
±±³          ³CH 292200      ³ do Sefaz                                   ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±³13/03/2014³Adriano Guedes | Pegar NCM do produto SB1 e nao do processo  ±±
±±³          ³CH 300913      ³ de Importacao na geracao do XML e Danfe    ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±³04/09/2014³Adriano Guedes | Pegar Numero de camadas da SBM->bm_a_qtdca  ±±
±±³          ³CH 302901      ³                                            ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±³30/09/2014³Alex Borges    | Imprimir a data de emissao da etiqueta no  ³±±
±±³          ³CH 301074      ³ Dados adicionais                           ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±³02/10/2014³Alex Borges    | Correçao de conversao de datas             ³±±
±±³          ³CH 301074      ³                                            ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³02/03/2015³Felipe (MRC)   ³ Projeto A005/15: Atualizacao da versao do  ³±±
±±³		 	 ³CH 316822      ³do layout do XML para 3.10. 				  ³±±
±±³ 	     ³               ³Equalizacao do fonte Crown X padrao TOTVS	  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³07/04/2015³Alex Borges    ³ Correção da transmissao de Nota Fiscal de  ³±±
±±³		 	 ³CH 319179      ³devolução de embalagem.   				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³07/08/2015³Ricardo Lima   ³ volta a tag para fci no produto            ³±±
±±³		 	 ³CH 328365      ³                                            ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³07/10/2015³Ricardo Lima   ³usa tabela CD5 quando for nota de recusa de ³±±
±±³		 	 ³CH 332534      ³exportacao, o sistema considera como        ³±±
±±³		 	 ³               ³importacao, porem nao eiste o processo no   ³±±
±±³		 	 ³               ³SigaEIC, controla pelo campo D1_TIPO_NF     ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³19/10/2015³Ricardo Lima   ³Mudanca da mensagem, diferimento parcial    ³±±
±±³		 	 ³CH 333438      ³icms DEC 1980/07 para Decreto 6080/12       ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³05/11/2015³Alex Borges    ³ Implementação do campo SUFRAMA.            ³±±
±±³		 	 ³CH 334357      ³                            				  ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±³16/11/2015³Alex Borges    ³ Projeto A023/15. Implementação da NT/2015. ³±±
±±³		 	 ³CH 335536      ³                            				  ³±±
±±³25/11/2015³CH 335536      ³Nova Adequação da NT/2015    				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³01/12/2015³Alex Borges    ³ Correção do Error.log ao transmitir uma NF ³±±
±±³		 	 ³CH 336528      ³ de saída de exportação.     				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³23/12/2015³Alex Borges    ³ Implementação NT2015/003                   ³±±
±±³		 	 ³CH 337955      ³                          				  ³±±
±±³29/12/2015³Alex Borges    ³ Problema na transmissão de NF Sucata       ³±±
±±³		 	 ³CH 337955      ³                          				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³30/12/15  ³RICARDO LIMA   ³CORRECAO PARA TRANSMISSAO DE NOTA DE CREDITO³±±
±±³		 	 ³CH 337955      ³DE ATVO FIXO                 				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³06/01/16  ³RICARDO LIMA   ³ Ajuste do Alias da consulta da etiqueta    ³±±
±±³		 	 ³CH  338475     ³                             				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³07/01/16  ³RICARDO LIMA   ³Ajuste do Campo de inscricao digitado errado³±±
±±³		 	 ³CH 338631      ³                             				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³07/01/16  ³ALEX BORGES    ³Destacar a TAG <entrega> para op. OnSite.   ³±±
±±³		 	 ³CH 338382      ³                             				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³14/01/16  ³ALEX BORGES    ³Correção da mensagem adicionais.            ³±±
±±³		 	 ³CH 338806      ³                             				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³18/01/16  ³ALEX BORGES    ³Adaptação do NFESEFAZ padrão.               ³±±
±±³		 	 ³CH 336234      ³                             				  ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±³15/04/16  ³ALEX BORGES    ³Projeto A005/16. Correção da transmissao de ³±±
±±³		 	 ³CH 346808      ³NF entrada qdo o cód. de produto começa com 4±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³06/05/16  ³RICARDO LIMA   ³Ajuste nf de referencia para complemento    ³±±
±±³		 	 ³CH 346808      ³de preco de exportacao       				  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³08/08/16  ³Bruno Silva    ³Retirado a subtracao do imposto de importação³±±
±±³		 	 ³CH 348700      ³No item da NF      				          ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³15/08/16  ³RICARDO LIMA   ³ inclui e-mail adicional da transpotadora   ³±±
±±³		 	 ³CH 334161      ³ para regra do rctrc - seguro    			  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³16/11/16  ³LUIZ CESAR     ³ Inclusao Ordem de Embarque                 ³±±
±±³		 	 ³CH 354503      ³                                 			  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³14/12/16  ³Ricardo Lima   ³ Ajuste no indice da busca da nf de origem  ³±±
±±³		 	 ³CH 358176      ³ o campo correto e D2_SERIORI    			  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³06/09/17  ³LUIZ CESAR     ³ Chamado 368661 - gravar pedido cliente     ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³04/10/17  ³Ricardo Lima   ³ Chamado 369903, Informa pedido do Protheus ³±±
±±³          ³               ³ para integrar no O2P                       ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
//Alterado por Allan Bonfim - 29/04/2010
Local _lMailEx	:= SuperGetMV("CE_MAILEXT", ,.T.)
...
// Luiz Cesar - 22/10/2010 - array de etiquetas
Local _aEtiquetas := {}

// Ricardo Lima - 16/11/2010 Op. Logistico
Local _lOpLog := .F.
...
//Alberto 12/07/11 - Informar o codigo do material de embalagem na etiqueta
Private _cFlagME  := GetMv("CE_FLAGME")

//Felipe (MRC) 21/03/12 - Variaveis para gravar pedido e item do cliente
Private _cPedCli   := ""
Private _cItPedCli := ""

Private _aPedCli := {} // Luiz Cesar - ch 368661 - gravar pedido cliente

//Ricardo Lima - 04/10/17
Private _cPedPrt   := ""
Private _cItPedPrt := ""
Private _cMsgO2P   := ""
...
If cTipo == "1"
	dbSelectArea("SA1")
	dbSetOrder(1)
	MsSeek(xFilial("SA1")+cClieFor+cLoja)   //Alberto 29/03/11- Alteracao na chave de pesquisa
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³Posiciona NF                                                            ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	dbSelectArea("SF2")
	...
	If MsSeek(xFilial("SF2")+cNota+cSerie+cClieFor+cLoja)
		...
		If MsSeek(xFilial("SF3")+cClieFor+cLoja+cNota+cSerie)
			While !SF3->(Eof()) .And. cClieFor+cLoja+cNota+cSerie == SF3->F3_CLIEFOR+SF3->F3_LOJA+SF3->F3_NFISCAL+SF3->F3_SERIE
				...
				Endif
				// Ricardo Lima - 04/10/17
				IF SUBSTR(Alltrim(SD2->D2_COD),1,1) = '4'
					_cPedPrt := SD2->D2_PEDIDO
					_cItPedPrt := SD2->D2_ITEMPV
				ENDIF
		...
		ElseIf FunName() == "SPEDNFSE"
			...
			aadd(aDest,ALLTRIM(SA1->A1_EMAIL))  // Ricardo Lima - 15/08/16
		...
		Else
			...
			If !SF2->F2_TIPO $ "DB"
			    dbSelectArea("SA1")
				dbSetOrder(1)
				//Alex Borges - 07/01/2015 - Chamado 338382
				If !Empty(SF2->F2_CLIENT) .AND. SF2->F2_CLIENT $ GetMv("CE_CLIDEP")
					//Posiciona o Código de cliente para buscar o cód. Cliente Dep Fechado.
					MsSeek(xFilial("SA1")+SF2->F2_CLIENT+SF2->F2_LOJENT)

					aAreaSA1 := SA1->(GetArea())

					cCliDepFec := SA1->A1_A_FATUR // Cód. Cliente Dep. Fechado

					MsSeek(xFilial("SA1")+cCliDepFec)//Posiona Cliente Dep. Fechado
					...
					RestArea(aAreaSA1)//Retorna a posição de Cliente anterior
				...
				*--------------------------*
				...
				//Alterado por Allan Bonfim - 29/04/2010
				If Upper(SA1->A1_EST) == "EX" .AND. !_lMailEx
				   	aadd(aDest,"")
				Else
					aadd(aDest,ALLTRIM(SA1->A1_EMAIL))  // Ricardo Lima - 15/08/16
			   	EndIf
			...
			Else
				...
				If !Upper(SA2->A2_EST) == "EX"
					//aadd(aDest,VldIE(SA2->A2_INSCR,.F.)) Alex Borges - 29/12/2015 - Chamado 337955
				...
				//Alterado por Allan Bonfim - 29/04/2010
			  	If Upper(SA2->A2_EST) == "EX" .AND. !_lMailEx
				   	aadd(aDest,"")
				Else
					aadd(aDest,ALLTRIM(SA2->A2_EMAIL))  // Ricardo Lima - 15/08/16
			   	EndIf
			...
			If !Empty(SF2->F2_TRANSP)
				...
				//Alterado por Allan Bonfim - 27/09/2010
				// Ricardo Lima - 15/08/16
				if SA4->A4_A_RCTRC = 'S'
				_cASD2 := GetNextAlias()
				BeginSql Alias _cASD2
				 SELECT BM_A_TIPO FROM %Table:SD2%
				 INNER JOIN %Table:SB1% ON D2_FILIAL=B1_FILIAL AND D2_COD=B1_COD
				 INNER JOIN %Table:SBM% ON B1_FILIAL=BM_FILIAL AND B1_GRUPO=BM_GRUPO
				 WHERE D2_DOC = %Exp:cNota% AND D2_SERIE = %Exp:cSerie% AND D2_CLIENTE = %Exp:cClieFor% AND D2_LOJA = %Exp:cLoja%
				 AND BM_A_TIPO IN ('T','L')
				EndSql

				  IF (_cASD2)->BM_A_TIPO = "T"
				    aadd(aTransp, ALLTRIM(SA4->A4_EMAIL) + ALLTRIM(SA4->A4_A_EMRCT) )
				  ELSE
				    aadd(aTransp,ALLTRIM(SA4->A4_EMAIL))
				  ENDIF
				  aadd(aTransp, ALLTRIM(SA4->A4_EMAIL) + ALLTRIM(SA4->A4_A_EMRCT) )
				else
				  aadd(aTransp,ALLTRIM(SA4->A4_EMAIL))
				...
				If !Empty(SF2->F2_VEICUL1)
					...
					aadd(aVeiculo,ALLTRIM(DA3->DA3_PLACA))
					aadd(aVeiculo,ALLTRIM(DA3->DA3_ESTPLA))
					...
					If !Empty(SF2->F2_VEICUL2)
						...
						aadd(aReboque,ALLTRIM(DA3->DA3_PLACA))
						aadd(aReboque,ALLTRIM(DA3->DA3_ESTPLA))
						...
						If !Empty(SF2->F2_VEICUL3)
							...
							aadd(aReboqu2,ALLTRIM(DA3->DA3_PLACA))
							aadd(aReboqu2,ALLTRIM(DA3->DA3_ESTPLA))
				...
				elseif !empty(SF2->F2_A_PLACA)
				   // LUIZ CESAR - 13/04/2009 - GRAVACAO DADOS DO VEICULO
					aadd(aVeiculo,ALLTRIM(SF2->F2_A_PLACA))
					aadd(aVeiculo,ALLTRIM(SF2->F2_A_UFP))
					aadd(aVeiculo,"")//RNTC
				EndIf
			EndIf
			...
			//////////////////////////////////////////////
			// Luiz Cesar - 31/05/2010 - Monta mensagem especifica para notas onde foram carregadas informacoes do Container (Remessa Importacao)
			If ALLTRIM(SF2->F2_A_CTNR)<>""

				//Felipe Geraldo - 24/04/12 - Se for exportacao de latas nacionais imprime somente o container
				If SF2->F2_EST == "EX"

					cMensCLI += " CONTAINER: " + Alltrim(SF2->F2_A_CTNR)

				Else

					// BUSCA PROCESSO DE IMPORTACAO ATRAVES DA OP GRAVADA NA ETIQUETA
					CB0->(DbOrderNickName("CB0NFSAI"))
					If CB0->(dbseek(xFilial("CB0")+SF2->F2_DOC+SF2->F2_SERIE))

						_cProdExt := ALLTRIM(GETMV("CE_PRODEXT"))
						lQuery := .T.
						_cAlias1SD1 := GetNextAlias()
						BeginSql Alias _cAlias1SD1
							SELECT D1_DOC,D1_FORNECE,D1_LOJA,D1_TIPO
							FROM %Table:SD1% SD1
							WHERE D1_FILIAL= %xFilial:SD1%
							AND SubStr(D1_COD,1,2)=%Exp:_cProdExt%
							AND D1_OP= %Exp:CB0->CB0_OP%
							AND SD1.%NotDel%
						EndSql

						_c1NotaCpl := (_cAlias1SD1)->D1_DOC // Numero da nota referente a entrada de materiais
						_c1SerNf   := SF2->F2_SERIE // Serie da Nota Mae
						_c1Clifor  := (_cAlias1SD1)->D1_FORNECE
						_c1Loja    := (_cAlias1SD1)->D1_LOJA
						_c1Tipo    := (_cAlias1SD1)->D1_TIPO

						SF1->(dbSetOrder(1))
						SF1->(MsSeek(xFilial("SF1")+_c1NotaCpl+_c1SerNf+_c1CliFor+_c1Loja+_c1Tipo))

						cMensCLI += "DI: " + SF2->F2_A_DI + " " + DTOC(SF2->F2_A_DTDI) + " " + SF1->F1_HAWB + " "
						If !SF1->(eof())
							cMensCLI += "REF NF: " +SF1->F1_DOC + " - " + DTOC(SF1->F1_EMISSAO) + " NO VALOR DE: " + Alltrim(STR(SF1->F1_VALBRUT,13,2))
						EndIf
						cMensCLI += " CONTAINER: " + SF2->F2_A_CTNR
					Endif

				EndIf
			Endif

            // Luiz Cesar - 16/11/2016 - Chamado 354503

            if Alltrim(SF2->F2_A_OE)<>""
               cMensCLI += " ORDEM DE EMBARQUE: " + SF2->F2_A_OE
            endif
			...
			#IFDEF TOP
				...
				cAliasSD2 := GetNextAlias()
                    *-------------------------------------------------------------*
                    * Alberto - 29/12/10 - Incluido os campos D2_VALIMP5,D2_VALIMP6      *
                    * que serao utilizados na mensagem complementar do PIS/COFINS de pauta*
                    *-------------------------------------------------------------*
                //Alberto - 24/09/13- chamado 269197-Inclusao do campo D2_EMISSAO que sera utilizado na mensagem da FCI
				BeginSql Alias cAliasSD2
						...
						D2_CLASFIS,D2_PRCVEN,D2_IDENTB6,D2_CODISS,D2_DESCZFR,D2_PREEMB,D2_DESCZFC,D2_DESCZFP,D2_LOTECTL,D2_NUMLOTE,D2_ICMSRET,D2_VALPS3,D2_VALIMP5,D2_VALIMP6,D2_EMISSAO,
			...
			//Luiz Cesar - 14/04/2009 - tratamento de multiplas CFOP
			_aCFOP := {}
            _aMensTes := {}
			_nTotPIS := 0
			_nTotCOF := 0

            //Alberto - 10/01/11 - Tratamento mensagem diferimento ICMS
            _cMensSF3 := " "

			//Luis Alberto - 14/10/2009 - tratamento de mensagem para on site
            _cTesven:=GetMv("CE_TESVDE1")  //Tes de Venda para on site com pallet originario de armazem externo
	...
	//						If MsSeek(xFilial("SD2")+(cAliasSD2)->D2_NFORI+(cAliasSD2)->D2_SERIORI+(cAliasSD2)->D2_CLIENTE+(cAliasSD2)->D2_LOJA+(cAliasSD2)->D2_COD+(cAliasSD2)->D2_ITEMORI)
					...
					//Alberto - 10/01/11 - Mensagem Diferimento ICMS Ponta Grossa
					dbSelectArea("SF3")
					dbSetOrder(4)
					If MsSeek(xFilial("SF3")+SF2->F2_CLIENTE+SF2->F2_LOJA+SF2->F2_DOC+SF2->F2_SERIE)
	                    If SF3->F3_ICMSDIF >0 .and. empty(_cMensSF3)
			               If Alltrim(SM0->M0_CODIGO+SM0->M0_CODFIL) = "0104"
			               		// Ricardo Lima - 19/10/2015
								//cMensFis := "Diferimento parcial ICMS cfe art.96 item I do DEC 1980/07. Base diferimento:R$ "+ALLTRIM(str(SF3->F3_VALICM+SF3->F3_ICMSDIF,13,2))+" -(diferimento parcial 33,33%)- Valor diferimento R$"+ALLTRIM(str(SF3->F3_ICMSDIF,13,2))
								cMensFis := "Diferimento parcial ICMS cfe art. 108, I do Decreto 6080/12. Base diferimento:R$ "+ALLTRIM(str(SF3->F3_VALICM+SF3->F3_ICMSDIF,13,2))+" -(diferimento parcial 33,33%)- Valor diferimento R$"+ALLTRIM(str(SF3->F3_ICMSDIF,13,2))
	                            _cMensSF3:="S"
			               Endif
	                    Endif
					EndIf
					...
					If !AllTrim(SC5->C5_MENNOTA) $ cMensCli
						...
						Else
							//cMensCli += IIF( SF2->(FieldPos("F2_MENNOTA")) > 0, AllTrim(SF2->F2_MENNOTA),AllTrim(SC5->C5_MENNOTA)) // Alex Borges - 14/01/16 - Chamado 338806
							cMensCli += AllTrim(SC5->C5_MENNOTA)
						EndIf

					EndIf

                    // Chamado 368661 - Luiz Cesar - Inserir numero do pedido na mensagem do DANFE.

                    IF ALLTRIM(SC6->C6_A_ITCL)<>""

			           aadd(_aPedCli, {SC5->C5_PEDCLIE,SC6->C6_A_ITCL})
		    		...
		    		//Alberto - 14/10/09 -Mensagem faturamento on site                        ³
	                IF (cAliasSD2)->D2_TES $ _cTesVen  //Verifica se o TES e de venda para on site com pallet originario de armazem externo
						dbSelectArea("PB5") //Tabela de etiquetas on site
						dbSetOrder(1)
						_cDoc       :=(cAliasSD2)->D2_DOC
						_cSerie     :=(cAliasSD2)->D2_SERIE
						_cCod       :=(cAliasSD2)->D2_COD
						_cAliasPB5 := GetNextAlias()

						//Alberto - 29/03/2011- Inclusao de tratamento para pb5_origem = 'P',etiqueta originaria do PIA
						BeginSql Alias _cAliasPB5
							SELECT PB5_FILIAL,PB5_SERFAT,PB5_NFFAT,PB5_SERORI,PB5_NFORI,PB5_CODPRO,PB5_ORIGEM,
							D2_DOC,D2_COD,D2_SERIE,D2_PEDIDO,C5_NUM,C5_MENNOTA
							FROM %Table:PB5% PB5, %Table:SD2% SD2,%Table:SC5% SC5
							WHERE
							PB5.PB5_FILIAL = %xFilial:PB5% AND
							SD2.D2_FILIAL  = %xFilial:SD2% AND
							SC5.C5_FILIAL  = %xFilial:SC5% AND
							PB5.PB5_SERFAT = %Exp:_cSerie% AND
							PB5.PB5_NFFAT  = %Exp:_cDoc% AND
							PB5.PB5_CODPRO = %Exp:_cCod% AND
							PB5.PB5_ORIGEM IN('E','P') AND
							PB5.PB5_SERORI = SD2.D2_SERIE AND
							PB5.PB5_NFORI  = SD2.D2_DOC   AND
							PB5.PB5_CODPRO = SD2.D2_COD   AND
							SD2.D2_PEDIDO  = SC5.C5_NUM   AND
							PB5.%NotDel%  AND
							SD2.%NotDel%  AND
							SC5.%NotDel%
						EndSql

				    	dbSelectArea(_cAliasPB5)
	                    DBGOTOP()
						While !Eof()
	                       If !substr((_cAliasPB5)->C5_MENNOTA,1,40) $ cMensCli
								cMensCli += ","+AllTrim((_cAliasPB5)->C5_MENNOTA)
							EndIf
	                       dbskip()
						Enddo
	                ...
	                Endif
		    		//Fim alteracao - Alberto - 14/10/09 -Mensagem faturamento on site

    	            //Luiz Cesar - 14/04/2009 - Acrescimo de PIS / COFINS de pauta nas mensagens
					If (SB1->B1_VLR_PIS <> 0 .AND. SB1->B1_VLR_COF <> 0)
						_nTOTPIS := _nTOTPIS + (cAliasSD2)->D2_VALIMP6
						_nTOTCOF := _nTOTCOF + (cAliasSD2)->D2_VALIMP5
					EndIf

	                //Luiz Cesar - 03/04/2009 - Mensagens fiscais customizadas
	                If Ascan(_aMensTes,(cAliasSD2)->D2_TES)=0
	                   SZF->(dbsetorder(1))
	                   IF SZF->(dbseek(xFilial("SZF")+SF4->F4_CMENS))
	                      cMensFis += " " + Alltrim(SZF->ZF_DESC)
	                   Endif

	                   IF SZF->(dbseek(xFilial("SZF")+SF4->F4_CMENS1))
	                      cMensFis += " " + Alltrim(SZF->ZF_DESC)
	                   Endif

	                   IF SZF->(dbseek(xFilial("SZF")+SF4->F4_CMENS2))
	                      cMensFis += " " + Alltrim(SZF->ZF_DESC)
	                   Endif

	                   IF SZF->(dbseek(xFilial("SZF")+SF4->F4_CMENS3))
	                      cMensFis += " " + Alltrim(SZF->ZF_DESC)
	                   Endif

	                   IF SZF->(dbseek(xFilial("SZF")+SF4->F4_CMENS4))
	                      cMensFis += " " + Alltrim(SZF->ZF_DESC)
	                   Endif

	                   aadd(_aMensTes,(cAliasSD2)->D2_TES)
	                Endif

	                //Luiz Cesar - 24/06/2009 - Tratamento numero DCRE
	                _cnDCRE := ""
	                If Alltrim(SM0->M0_CODIGO+SM0->M0_CODFIL) = "0101"
	                   If !empty(SB1->B1_A_DCRE)
	                      _cnDCRE := " DCR-E " + Alltrim(SB1->B1_A_DCRE)
	                   EndIf
	                EndIf
		            ...
		            //Felipe - 31/08/2011 - Busca o tipo do frete (CIF ou FOB) apenas no pedido de PA ou PI
					If Alltrim(SB1->B1_TIPO) == "PA" .OR. Alltrim(SB1->B1_TIPO) == "PI"
						If SC5->C5_TPFRETE=="C"
							cModFrete := "0"
					...
					//Felipe - 31/08/2011 - Busca o tipo do frete (CIF ou FOB) para quando a NF nao for de latas
	                ...
	                //Alberto - 24/09/13- chamado 269197- Incluida mensagem para a FCI
					_nMesRef := SUBSTR((cAliasSD2)->D2_EMISSAO,5,2)
					_nAnoRef := SUBSTR((cAliasSD2)->D2_EMISSAO,1,4)
					_cPerCal := _nMesRef+_nAnoRef
					...
					//-----------------------------------------------------------------------------------------
                    //Alberto - 01/10/13- chamado 269197- Conforme orientacao do Claudinei do fiscal, verificar apenas a origem do produto na geracao da mensagem da FCI
					...
					//--------------------------------------------------------------------------------
					If AliasIndic("CFD")
						CFD->(DbSetOrder(2))   //Tabela de Ficha de Conteudo de Importação
						If CFD->(DbSeek(xFilial("CFD")+(cAliasSD2)->D2_COD+_cPerCal))
							_cFCICOD	:= IIf(CFD->(FieldPos("CFD_VPARIM")) > 0,CFD->CFD_FCICOD, " ")
							_nContImp	:= IIf(CFD->(FieldPos("CFD_CONIMP")) > 0,CFD->CFD_CONIMP, 0)
							cInfAdic  += cMsgFci + ", Numero da FCI " + Alltrim(_cFCICOD)
						EndIf
					EndIf
	                ...
	                //Felipe/Alberto - 31/10/11- Retirada do campo B1_CODBAR do array aprod
					aadd(aProd,	{Len(aProd)+1,;
						(cAliasSD2)->D2_COD,; //cCodProd,;
						IIf(Val(SB1->B1_CODBAR)==0,"",StrZero(Val(SB1->B1_CODBAR),Len(Alltrim(SB1->B1_CODBAR)),0)),;//"",;
						IIF(Empty(SC6->C6_DESCRI),SB1->B1_DESC,SC6->C6_DESCRI),;//cDescProd,;
						...
						SB1->B1_EX_NCM,;
						(cAliasSD2)->D2_CF,; //cD2Cfop,; // Alterado por Allan Bonfim - 28/09/2010//cD2Cfop,;
						SB1->B1_UM,;
						(cAliasSD2)->D2_QUANT,;
	                ...
	                Elseif SUBSTR((cAliasSD2)->D2_CF,1,1) ='7'  //Jose Francisco - 28/03/11 - Tratamento local de embarque para exportacao obrigatorio P/Versao 2.00
	                    Dbselectarea("SC5")
	                    Dbsetorder(1)
						If DbSeek(xFilial("SC5")+(cAliasSD2)->D2_PEDIDO)
		                    Dbselectarea("SY9")//Tabela Porto/Aeroportos
	    	                Dbsetorder(1)
							If DbSeek(xFilial("SY9")+SC5->C5_A_LOEMB)
						    	aAdd(aDados,{"ZA02","ufEmbarq"  , IIF(SY9->(FieldPos("Y9_ESTADO"))<>0, SY9->Y9_ESTADO ,"") })
						    	aAdd(aDados,{"ZA03","xLocEmbarq", IIF(SY9->(FieldPos("Y9_DESCR") )<>0, SY9->Y9_DESCR  ,"") })
						    	aAdd(aDados,{"I51","nDraw", "" })
						    	aAdd(aDados,{"I53","nRE" ,  "" })
						    	aAdd(aDados,{"I54","chNFe", "" })
						    	aAdd(aDados,{"I55","qExport", "" })
						    	aAdd(aDados,{"ZA04","xLocDespacho","" })
						    	aAdd(aExp,aDados)
		                    Else
								aadd(aExp,{})
	        	            Endif
			...
			//Luiz Cesar 16/04/2009 - Mensagem PIS e COFINS de Pauta
			If _nTotPIS>0 .OR. _ntotCOF>0
				cMensFis += "  PIS de Pauta. R$ "+alltrim(str(_ntotPIS,13,2))+". "
				cMensFis += "  COFINS de Pauta. R$ "+alltrim(str(_ntotCOF,13,2))+". "
			EndIf
	...
	EndIf
Else
	//Alterado por Ricardo Lima - 11/11/2010 - Fornecedor nao usa op logistico
	 aadd(_aEtiquetas, {} )
		...
		Else
			...
			Else
				...
				If SF1->(FieldPos("F1_FORENT")) <> 0 .And. !Empty(SF1->F1_FORENT+SF1->F1_LOJAENT) .And. SF1->F1_FORENT+SF1->F1_LOJAENT <> SF1->F1_FORNECE+SF1->F1_LOJA
					...
					aadd(aEntrega,SA2->A2_INSCR)  // Ricardo Lima - 07/01/16
				EndIf
			EndIf
            ...
            // LUIZ CESAR - 16/04/2009 - AJUSTES EIC - Dados da Transportadora
			//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
			//³Posiciona transportador  para buscar impressao de notas de importacao   ³
			//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
			If !Empty(SA2->A2_TRANSP) .AND. SF1->F1_EST='EX'
			   dbSelectArea("SA4")
			   dbSetOrder(1)
			   MsSeek(xFilial("SA4")+SA2->A2_TRANSP)
			...
			//Alterado por Allan Bonfim - 28/09/2010
			/*
			cScan := "1"
			If (FieldPos("F1_ESPECI"+cScan))>0
				...
				EndDo
			EndIf*/
			aadd(aEspVol,{ "VOLUMES", SF1->F1_A_VOLUM , SF1->F1_PESOL , SF1->F1_A_PESOB})
			...
			If FieldPos("F1_TRANSP") > 0 .And. !Empty(SF1->F1_TRANSP)
				...
				If !Empty(SF1->F1_PLACA)
					aadd(aVeiculo,ALLTRIM(SF1->F1_PLACA))
					aadd(aVeiculo,ALLTRIM(SA4->A4_EST))
					aadd(aVeiculo,"")//RNTC
				EndIf
			EndIf
			...
			#IFDEF TOP
				...
				BeginSql Alias cAliasSD1
						...
						D1_NUMLOTE,D1_CUSTO,D1_ORIGLAN,D1_DESCICM,D1_II,D1_FORMUL,D1_VALPS3,D1_ORIGLAN,D1_VALCF3,D1_TESACLA,D1_IDENTB6,D1_CDESCRI  %Exp:cField%
						FROM %Table:SD1% SD1
						WHERE
            ...
            // Luiz Cesar - 16/04/2009 - Mensagens fiscais customizadas para entradas
            // Mensagens Entradas
            cMensFis += " " + alltrim(SF1->F1_MENNOTA)
            cMensFis += " " + alltrim(SF1->F1_MENNOT2)
            cMensFis += " " + alltrim(SF1->F1_MENNOT3)
            cMensFis += " " + alltrim(SF1->F1_MENNOT4)
            cMensFis += " " + alltrim(SF1->F1_MENNOT5)
			...
			While !Eof() .And. xFilial("SD1") == (cAliasSD1)->D1_FILIAL .And.;
				...
				EndIf
                // Luiz Cesar - 16/04/2009 - Mensagens fiscais customizadas para entradas
                if Ascan(_aMensTes,(cAliasSD1)->D1_TES)=0
                   SZF->(dbsetorder(1))
                   IF SZF->(dbseek(xFilial("SZF")+SF4->F4_CMENS))
                      cMensFis += " " +Alltrim(SZF->ZF_DESC)
                   Endif
                   ...
                   IF SZF->(dbseek(xFilial("SZF")+SF4->F4_CMENS4))
                      cMensFis += " " +Alltrim(SZF->ZF_DESC)
                   Endif
                   AADD(_aMensTes,(cAliasSD1)->D1_TES)
                Endif
				//Anfavea
				If lAnfavea
					dbSelectArea("CDR")
			   ...
			   EndIF
				...
				// Luiz Cesar - 28/04/2009 - Busca descricao informada no EIC
				_cDPrdEx :=	if(SF1->F1_EST='EX',Alltrim(MSMM(SB1->B1_DESC_P,120)),"")
				_cDPrdEx := if(alltrim(_cdPrdEX)<>"",_cdPrdEx,SB1->B1_DESC)

                // Luiz Cesar - 13/05/2009 - Tratamento para devolucoes
                If (cAliasSD1)->D1_TIPO$"D" .AND. ALLTRIM((cAliasSD1)->D1_CDESCRI)<>"" .AND. SF1->F1_EST<>'EX'
                   _cDPrdEx := (cAliasSD1)->D1_CDESCRI
                Endif
		       ...
		       EndIf
				...
				aadd(aProd,	{Len(aProd)+1,;
					(cAliasSD1)->D1_COD,;
					IIf(Val(SB1->B1_CODBAR)==0,"",StrZero(Val(SB1->B1_CODBAR),Len(Alltrim(SB1->B1_CODBAR)),0)),; //"",;
					IIf (Empty(_cDPrdEx),SB1->B1_DESC,_cDPrdEx),; // Alterado por Allan Bonfim - 30/09/2010
					SB1->B1_POSIPI,;
					SB1->B1_EX_NCM,;
					(cAliasSD1)->D1_CF,;
					SB1->B1_UM,;
					...
					((cAliasSD1)->D1_VALDESC + nDescRed + nDescIcm),;
				   	IIF(!(cAliasSD1)->D1_TIPO$"IP",(cAliasSD1)->D1_VUNIT,0),;       //- (cAliasSD1)->D1_II
				   	IIF(SB1->(FieldPos("B1_CODSIMP"))<>0,SB1->B1_CODSIMP,""),; //codigo ANP do combustivel
					IIF(SB1->(FieldPos("B1_CODIF"))<>0,SB1->B1_CODIF,""),; //CODIF
...
If !Empty(aNota)
	...
	For nX := 1 To Len(aProd)
		...
		//Alberto - 29/03/11 - Utilizar array aprod pois a tabela SD2 nao esta posicionada
	    //If substr(aprod[nx][2],1,1)='4'
	    If substr(aprod[nx][2],1,1)='4' .AND. cTipo = '1'  // Alex Borges - 15/04/16 - Chamado 346808
			aadd(_aEtiquetas, VERETIQ())
	    Else
			aadd(_aEtiquetas,{})
	    Endif
		...
		cString += NfeItem(aProd[nX],aICMS[nX],aICMSST[nX],aIPI[nX],aPIS[nX],aPISST[nX],aCOFINS[nX],aCOFINSST[nX],aISSQN[nX],aCST[nX],;
		           ...
		           @cMensFis,aCsosn[Nx],aPedCom[nX],aNota,aICMSZFM[nX],aDest,cIpiCst,aFCI[nX],lIcmDevol,@nVicmsDeson,@nVIcmDif,cMunPres,;
					aAgrPis[nX],aAgrCofins[nX],nIcmsDif,aICMUFDest[nX],@nvFCPUFDest,@nvICMSUFDest,@nvICMSUFRemet,cAmbiente,_aEtiquetas[nX],_lOpLog , cSerie , cNota)


		//Felipe (MRC) - 21/03/2012 - Grava o numero do pedido do cliente na mensagem adicional
		If	!Empty(_cPedCli)
			cMensCli += " Nro. Pedido Cliente: " +  Alltrim(_cPedCli)
		EndIf

		//Felipe (MRC) - 21/03/2012 - Grava o item do pedido do cliente na mensagem adicional
		If	!Empty(_cItPedCli)
			cMensCli += " / Item: " +  Alltrim(_cItPedCli) + " "
		EndIf

		//Alberto - 14/07/11- Informar etiquetas na mensagem do cliente
        If !empty(_aEtiquetas[nX]).and. _lOpLog
	        cMensCli += MSGETIQ(_aEtiquetas[nX])
	    Endif

		//Alex Borges 07/03/14 Chamado 290430
		If Empty(SA1->A1_A_OPER) // Se for operador logistico não envia o Número da OP
			If !empty(_aEtiquetas[nX])
		        cMensCli += MSGETOP(_aEtiquetas[nX])
		    Endif
	   EndIf

	Next nX

	//Alex Borges - 05/11/2015 - Chamado 334357
	If !Empty(aDest[15])
		cMensCli += " Cod. SUFRAMA: "+Alltrim(aDest[15])
	EndIf
...
*/
// Ricardo Lima - 06/05/16
ElseIf !Empty(aExp[1]) .and. !lEECFAT .and. aNota[04] == "1" .and. !Empty(aNfVinc)
	For nX := 1 To Len(aNfVinc)
		If !Empty(aNfVinc[nX][7])
			If !aNfVinc[nX][7] $ cChaveRef
				cChaveRef += '<refNFe>'+ConvType(aNfVinc[nX][7],44)+'</refNFe>'
			EndIf
		EndIf
	Next nX
	If !Empty(cChaveRef)
...
//------------------------------------------------------------------------
//Adriano Guedes em 13/03/2014
//------------------------------------------------------------------------
Local cFci          := SuperGetMV("CE_NUMFCI",," ")  // Parametro com o cod. FCI para os produtos
Local cCfoFci       := SuperGetMV("CE_CFOFCI",," ")  // Parametro com os CFOPs que devem gerar a TAG nFCI
Local cOriFci       := SuperGetMV("CE_ORIFCI",," ")  // Parametro com as origens de produto (B1_ORIGEM) que devem gerar a TAG nFCI
//------------------------------------------------------------------------
...
//Felipe (MRC) 21/03/12 - Zera as Variaveis
_cPedCli   := ""
_cItPedCli := ""
...
//Alterado para cinco casas decimais por Adriano Guedes em 10/02/2014  chamado 289453
//cString += '<qCom>'+ConvType(aProd[09],15,4)+'</qCom>'
cString += '<qCom>'+ConvType(aProd[09],16,5)+'</qCom>'
//------------------------------------------------------------------------------------
...
If cVerAmb >= "3.10" .and. Len(aExp)>0
	...
	Else
		/*For nX := 1 To Len(aExp)
			...
			EndIf
		Next
		*/ //Alex Borges - 01/12/2015 - Chamado 336528
		If Len(aExp) > 0
			If ConvType(aExp[03][1]) == "I51"
				cString += '<detExport>'
...
//Felipe (MRC) - 21/03/2012 - Busca na tabela de precos o numero do pedido do cliente
If Alltrim(cTipo) == "1" .and. Empty(_aPedCli) // Luiz Cesar - Chamado 368661 - correcao gravacao pedido
	_aPedCli := BuscaSZS(cSerie,cNota,Alltrim(aProd[02]))
EndIf

//Felipe (MRC) - 21/03/2012 - Grava as Tags xPed e nItemPed

// Luiz Cesar - Chamado 368661 - correcao gravacao pedido - ajuste no array _aPedcli
If Len(_aPedCli) > 0
	cString += '<xPed>'+ConvType(_aPedCli[1,1])+'</xPed>'
	_cPedCli := _aPedCli[1,1]
	If !Empty(_aPedCli[1,2])
		cString += '<nItemPed>'+ConvType(_aPedCli[1,2])+'</nItemPed>'
		_cItPedCli := _aPedCli[1,2]
	EndIf
Endif
...
EndIf
*/
//***COMENTADO POR FELIPE - PROJETO NFe 3.10 - OU DEIXA O FCI DO TRECHO ACIMA OU ESSE ABAIXO
//Adriano Guedes FCI em  13/03/2014
If !Empty(cFci) .and. posicione("SB1",1,xFilial("SB1")+alltrim(aprod[02]),"B1_ORIGEM") $ Alltrim(cOriFci) .AND. alltrim(aprod[07])$ Alltrim(cCfoFci)
	cString += '<nFci>'+alltrim(cFci)+'</nFci>'
Endif
...
*/
// Ricardo Lima - 04/10/17
IF substr(aProd[3],1,1) = '4'
	_cMsgO2P := "PVPRTO2P("+_cPedPrt+"-"+_cItPedPrt+")"
else
	_cMsgO2P := ""
ENDIF

cString += '<infadprod>'+ConvType(aProd[25],500)+cMensDeson+cDedIcm+cCrgTrib+_cMsgO2P+'</infadprod>'
...
For nX := 1 To Len(aVol)
	cString += '<vol>'
		...
		cString += NfeTag('<pesoL>' ,ConvType(aVol[nX][03],15,4)) // Luiz Cesar mudar para 3?
		cString += NfeTag('<pesoB>' ,ConvType(aVol[nX][04],15,4))
...
IF cTipo == "1" .And. cF2Tipo == "C" .And. len (aProd) > 0
	...
	If SD2->( DbSeek(xFilial("SD2")+ SD2->D2_DOC + SD2->D2_SERIE ))
		If !Empty(SD2->D2_NFORI)
			...
			SF2->( DbSeek(xFilial("SF2")+ SD2->D2_NFORI + SD2->D2_SERIORI ))  // Ricardo Lima - 14/12/16
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºFuncao    ³ Veretiq     º Autor ³ Luiz Cesar                             º Data ³ 22/10/2010 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Buscar Etiquetas no CB0                                                          º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºObjetivo  ³ Montar array com etiquetas para gravacao no XML                                  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºParametros³                                                                                  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍÏÍÍÑÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±º Autor       ³ Data     ³ Funcao      | Alteracao                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±º             ³          ³             |                                                      º±±
±±ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function VERETIQ()

Local _aetiq := {}
Local _nCamadas := 0 // Adriano Guedes 04/09/2014 chamado 302901

lQuery := .T.
_cAlias1CB0 := GetNextAlias()
BeginSql Alias _cAlias1CB0

//	   SELECT CB0_CODETI,CB0_QTDE,CB0_A_TPEM ////Alberto 12/07/11 - Informar o codigo do material de embalagem na etiqueta
//      SELECT CB0_CODETI,CB0_QTDE,CB0_A_TPEM, CB0_OP // Alex Borges 07/03/2014 Chamado 290430
//       SELECT CB0_CODETI,CB0_QTDE,CB0_A_TPEM, CB0_OP , CB0_CODPRO // Adriano Guedes 04/09/2014 chamado 302901
	  SELECT CB0_CODETI,CB0_QTDE,CB0_A_TPEM, CB0_OP , CB0_CODPRO, CB0_DTNASC //Alex Borges - 30/09/2014 - Chamado 301074
	   FROM %Table:CB0% CB0
	   WHERE
    	 CB0_FILIAL = %xFilial:CB0%
	     AND CB0_NFSAI  = %EXP:SF2->F2_DOC%
    	 AND CB0_SERIES = %EXP:SF2->F2_SERIE%
	     AND CB0.%NotDel%
EndSql

(_cAlias1CB0)->(dbgotop())
While !(_cAlias1CB0)->(eof())
	// Adriano Guedes 04/09/2014 chamado 302901------------------------------------------
	DbSelectArea("SB1")
	DbSetOrder(1)
	If SB1->(DbSeek(xFilial("SB1")+(_cAlias1CB0)->CB0_CODPRO))
    	_nCamadas := (Posicione("SBM",1,xFilial("SBM")+SB1->B1_GRUPO,"BM_A_QTDCA")/1000)
    Endif
	//-----------------------------------------------------------------------------------
   If _cFlagME = "S"  //Alberto 12/07/11 - Informar o codigo do material de embalagem na etiqueta
       PBZ->(Dbsetorder(1))
	   If (PBZ->(MsSeek(xFilial("PBZ")+(_cAlias1CB0)->CB0_A_TPEM)))
	       // _nQtdFol:= Int((_cAlias1CB0)->CB0_QTDE/0.389)+1     // Adriano Guedes 04/09/2014 chamado 302901 (valor estava chumbado )
           _nQtdFol:= Int((_cAlias1CB0)->CB0_QTDE/_nCamadas)+1    // Adriano Guedes 04/09/2014 chamado 302901
//		   aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,PBZ->PBZ_A_PAL,PBZ->PBZ_A_FOL,PBZ->PBZ_A_QUA})
		   //aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,PBZ->PBZ_A_PAL,1,PBZ->PBZ_A_FOL,_nQtdFol,PBZ->PBZ_A_QUA,1})//Alberto - 13/07/11- Gravar a qtde do material de embalagem
		   //aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,PBZ->PBZ_A_PAL,1,PBZ->PBZ_A_FOL,_nQtdFol,PBZ->PBZ_A_QUA,1,(_cAlias1CB0)->CB0_OP})//Alex Borges 07/03/14 Chamado 290430
		   //aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,PBZ->PBZ_A_PAL,1,PBZ->PBZ_A_FOL,_nQtdFol,PBZ->PBZ_A_QUA,1,(_cAlias1CB0)->CB0_OP,(_cAlias1CB0)->CB0_DTNASC})//Alex Borges - 30/09/2014 - Chamado 301074
		   aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,PBZ->PBZ_A_PAL,1,PBZ->PBZ_A_FOL,_nQtdFol,PBZ->PBZ_A_QUA,1,(_cAlias1CB0)->CB0_OP,sTod((_cAlias1CB0)->CB0_DTNASC)})//Alex Borges - 02/10/2014 - Chamado 301074
       Else
		   //aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,'',0,'',0,'',0})
		   //aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,'',0,'',0,'',0,CB0->CB0_OP}) // Alex Borges Chamado 290430
		   aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,'',0,'',0,'',0,(_cAlias1CB0)->CB0_OP,stod((_cAlias1CB0)->CB0_DTNASC)}) //Alex Borges - 30/09/2014 - Chamado 301074 // Ricardo Lima - 06/01/16
       Endif
   Else
	   //aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE}) //Alberto - 29/03/11- Informar a qtde da etiqueta
	   //aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,CB0->CB0_OP}) // Alex Borges Chamado 290430
	   aadd(_aetiq,{Alltrim((_cAlias1CB0)->CB0_CODETI),(_cAlias1CB0)->CB0_QTDE,(_cAlias1CB0)->CB0_OP,stod((_cAlias1CB0)->CB0_DTNASC)}) //Alex Borges - 30/09/2014 - Chamado 301074 // Ricardo Lima - 06/01/16
   Endif
   (_cAlias1CB0)->(dbskip())
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºFuncao    ³ MsgEtiq     º Autor ³ Luiz Cesar                             º Data ³ 22/10/2010 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Montar Mensagem de etiquetas                                                     º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºObjetivo  ³ Gerar mensagem com base no array parametrizado                                   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºParametros³ _aEtiquetas array para msg de etiquetas                                          º±±
±±ÌÍÍÍÍÍÍÍÍÍÍÏÍÍÑÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±º Autor       ³ Data     ³ Funcao      | Alteracao                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±º             ³          ³             |                                                      º±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
Static Function MSGETIQ(_aEtiq)

Local _cRet := "ETIQUETAS: "

for _i:= 1 to Len(_aEtiq)

   If _cFlagME = "S"  //Alberto 12/07/11 - Informar o codigo do material de embalagem na etiqueta
	   _cRet := _cRet + _aEtiq[_i,1] +";"+ALLTRIM(STR(_aEtiq[_i,2]))+";"+ALLTRIM(_aEtiq[_i,3])+";"+ALLTRIM(STR(_aEtiq[_i,4]))+";"+ALLTRIM(_aEtiq[_i,5])+";"+ALLTRIM(STR(_aEtiq[_i,6]))+";"+ALLTRIM(_aEtiq[_i,7])+";"+ALLTRIM(STR(_aEtiq[_i,8]))
   Else
	   _cRet := _cRet + _aEtiq[_i,1]  +";"+ALLTRIM(STR(_aEtiq[_i,2]))  //Alberto - 29/03/2011 - Informar qtde da etiqueta
   Endif
...
Return (convtype(_cRet,Len(_cRet)))

/*/
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºFuncao    ³  BuscaSZS   º Autor ³ Felipe Geraldo (MRC)                   º Data ³ 21/03/2012 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Buscar numero e item do pedido do cliente na tabela de preco	                    º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºObjetivo  ³ Gravar o numero e item do pedido do cliente p/ gravar nas tags xPed e nItemPed   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºParametros³ Serie e Numero da NF					                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍÏÍÍÑÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±º Autor       ³ Data     ³ Funcao      | Alteracao                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±º             ³          ³             |                                                      º±±
...
Static Function BuscaSZS(_cSerNF,_cNumNF,_cCodPro)
...
dbSelectArea("SF2")
dbSetOrder(1)
If dbSeek( xFilial("SF2") + _cNumNF + _cSerNF )

	If Select("TBR1") > 0
		TRB1->(dbCloseArea())
	EndIf
	_cQuery := " SELECT F2_DOC,F2_SERIE,F2_CLIENTE,F2_LOJA, D2_COD,D2_PEDIDO, B1_TIPO, C5_NUM,C5_TABELA, ZS_CODTAB,ZS_CODPRO,ZS_A_PEDCL,ZS_A_ITPCL "
	_cQuery += " FROM " + RetSqlName("SF2") + " SF2, " + RetSqlName("SD2") + " SD2, " + RetSqlName("SC5") + " SC5, " + RetSqlName("SB1") + " SB1, " + RetSqlName("SZS") + " SZS " + _cEol
	_cQuery += " WHERE F2_FILIAL = D2_FILIAL "     + _cEol
	_cQuery += " AND F2_DOC = D2_DOC "             + _cEol
	_cQuery += " AND F2_SERIE = D2_SERIE "         + _cEol
	_cQuery += " AND F2_CLIENTE = D2_CLIENTE "     + _cEol
	_cQuery += " AND F2_LOJA = D2_LOJA "           + _cEol
	_cQuery += " AND D2_FILIAL = C5_FILIAL "       + _cEol
	_cQuery += " AND D2_PEDIDO = C5_NUM "          + _cEol
	_cQuery += " AND D2_FILIAL = B1_FILIAL "       + _cEol
	_cQuery += " AND D2_COD = '" + _cCodPro + "' " + _cEol
	_cQuery += " AND D2_COD = B1_COD "             + _cEol
	_cQuery += " AND B1_TIPO IN ('PA','PI') "      + _cEol
	_cQuery += " AND ZS_FILIAL = C5_FILIAL "       + _cEol
	_cQuery += " AND ZS_CODTAB = C5_TABELA "       + _cEol
	_cQuery += " AND ZS_CODPRO = D2_COD "          + _cEol
	_cQuery += " AND F2_FILIAL = '" + xFilial("SF2") + "' " + _cEol
	_cQuery += " AND F2_DOC = '" + SF2->F2_DOC + "' "       + _cEol
	_cQuery += " AND F2_SERIE = '" + SF2->F2_SERIE + "' "   + _cEol
	_cQuery += " AND F2_CLIENTE = '" + SF2->F2_CLIENTE + "' " + _cEol
	_cQuery += " AND F2_LOJA =  '" + SF2->F2_LOJA + "' "    + _cEol
	_cQuery += " AND SF2.D_E_L_E_T_ = ' ' "                 + _cEol
	_cQuery += " AND SD2.D_E_L_E_T_ = ' ' "                 + _cEol
	_cQuery += " AND SC5.D_E_L_E_T_ = ' ' "                 + _cEol
	_cQuery += " AND SB1.D_E_L_E_T_ = ' ' "                 + _cEol
	_cQuery += " AND SZS.D_E_L_E_T_ = ' ' "                 + _cEol
	_cQuery  := ChangeQuery(_cQuery)
	Memowrite("NFe_SZR.SQL",_cQuery)
	dbUseArea( .T., "TopConn", TCGenQry(,,_cQuery), "TRB1" , .F., .F. )

	//Busca o Numero do Pedido do Cliente
	dbSelectArea("TRB1")
	dbGoTop()
	If TRB1->(!Eof())
		If !Empty(TRB1->ZS_A_PEDCL)
//			aAdd(_aRet,{Alltrim(TRB1->ZS_A_PEDCL))
//			aAdd(_aRet,Alltrim(TRB1->ZS_A_ITPCL))
			aAdd(_aRet,{Alltrim(TRB1->ZS_A_PEDCL),Alltrim(TRB1->ZS_A_ITPCL)})
		EndIf
	EndIf
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºFuncao    ³ MSGETOP     º Autor ³ Alex Borges                            º Data ³ 07/03/2014 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Montar Mensagem das ordens de produção - Chamado 290430                          º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±º Autor       ³ Data     ³ Funcao      | Alteracao                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±º             ³          ³             |                                                      º±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
Static Function MSGETOP(_aEtiq)

Local _cRet := " Nro. OP: "

for _i:= 1 to Len(_aEtiq)
	If _cFlagME = "S"
		If !(alltrim(_aEtiq[_i,9]) $ _cRet)
	    	_cRet := _cRet +Alltrim(_aEtiq[_i,9])+";"
		EndIf
    Else
      If !(alltrim(_aEtiq[_i,3]) $ _cRet)
	    	_cRet := _cRet +Alltrim(_aEtiq[_i,3])+";"
		EndIf
	EndIf
next

//Alex Borges - 30/09/2014 - Chamado 301074
//Ira buscar as datas das etiquetas
_cRet += " Data das Etiquetas:"
for _i:= 1 to Len(_aEtiq)
	If _cFlagME = "S"
		cData := dToc(_aEtiq[_i,10])
		If !(cData $ _cRet)
	    	_cRet := _cRet +cData+";"
		EndIf
    Else
    	cData := dToc(_aEtiq[_i,4])
    	If !(cData $ _cRet)
			_cRet := _cRet +cData+";"
		EndIf
	EndIf
